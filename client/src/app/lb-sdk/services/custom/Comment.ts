...
export class CommentApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getFrom(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/comments/:id/from";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getTo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/comments/:id/to";
    let _routeParams: any = {
