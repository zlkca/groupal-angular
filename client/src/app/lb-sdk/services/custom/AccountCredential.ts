...
/**
 * Api services for the `AccountCredential` model.
 */
@Injectable()
export class AccountCredentialApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id AccountCredential id
   *
